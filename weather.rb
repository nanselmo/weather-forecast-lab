...
# 3. Using the methods above and string interpolation, update the weather_report method below so that it returns a string that describes the current weather - for example: "The weather in New York is Partly Cloudy. The temperature is 66.1 degrees Farenheit." HINT: the method should RETURN the string, not print it to the terminal. 
def weather_report(weather_hash)
end	
	

#4. Write a method city_weather_info that takes in the weather hash as an argument. 
...
# BONUS:  Write a method, convert_temp, that takes in the weather hash as an argument and converts the farenheit temperature to celcius. Have the method round your answer to two decimal places. Is there a method we can use to round in Ruby?
